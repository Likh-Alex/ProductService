resource "aws_cloudfront_distribution" "default_cloudfront_distribution" {
  enabled         = true
  ...
  default_cache_behavior {
    ...
    target_origin_id       = aws_alb.application_load_balancer.name
  ...
  origin {
    ...
    origin_id   = aws_alb.application_load_balancer.name
